...
@Component({
  ...
  styles: [`
    ...
    .rm-home-nav { position: sticky; top: 0; z-index: 100; min-height: 64px; height: auto; padding: 8px 32px; border-bottom: 1px solid var(--rm-border-base); flex-wrap: wrap; @media (max-width: 768px){ padding: 8px 16px; } @media (max-width: 375px){ padding: 8px 10px; } }
    .rm-home-nav__inner { max-width: 1200px; margin: 0 auto; min-height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap; min-width: 0; @media (max-width: 768px){ gap: 8px; } }
    .rm-home-brand { display: flex; align-items: center; gap: 10px; min-width: 0; flex-shrink: 1; }
    .rm-home-logo-mark { width: 32px; height: 32px; border-radius: var(--rm-radius-md); background: var(--rm-accent); color: #fff; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 10px rgba(99,102,241,0.3); &.small { width: 24px; height: 24px; } }
    ...
    .rm-hero-bg { position: absolute; inset: -60px -24px 0 -24px; z-index: -1; pointer-events: none; overflow: hidden; }
    .rm-hero-orb { position: absolute; top: -100px; left: 50%; transform: translateX(-50%); width: 780px; height: 560px; background: radial-gradient(ellipse 68% 62% at 50% 0%, rgba(99,102,241,0.28) 0%, rgba(139,92,246,0.16) 32%, rgba(59,130,246,0.08) 52%, transparent 72%); filter: blur(0px); animation: rmOrbFloat 9s ease-in-out infinite; will-change: transform; }
    .rm-hero-orb--2 { top: 40px; width: 520px; height: 380px; background: radial-gradient(ellipse 70% 60% at 50% 50%, rgba(99,102,241,0.10) 0%, transparent 70%); animation: rmOrbFloat2 12s ease-in-out infinite; }
    ...
    .rm-hero-title { font-family: var(--rm-font-display); font-size: 58px; font-weight: 800; line-height: 1.02; letter-spacing: -0.045em; color: var(--rm-text-primary); min-height: 126px; overflow-wrap: anywhere; word-break: break-word; @media (max-width: 768px) { font-size: 44px; min-height: 104px; } @media (max-width: 640px) { font-size: 36px; min-height: 92px; } @media (max-width: 375px) { font-size: 30px; line-height: 1.08; min-height: 78px; } }
    ...
    .rm-section-title { font-family: var(--rm-font-display); font-size: 36px; font-weight: 800; letter-spacing: -0.035em; line-height: 1.1; }
    .rm-section-desc { font-size: 15px; color: var(--rm-text-secondary); max-width: 640px; line-height: 1.55; }
